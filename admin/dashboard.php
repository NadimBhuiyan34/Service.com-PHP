    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-4">
         ...
         LEFT JOIN users u2 ON sr.servicer_id = u2.id
         ...
         LIMIT 6         
            ";
                ...
                while ($request = mysqli_fetch_assoc($result)) {
                  // $timestamp = "2023-10-19 15:30:00"; // Replace this with your timestamp
                  ...
                  // Get the total minutes and hours from the difference
                  $totalMinutes = $interval->i;
                  $totalHours = $interval->h;
                ?>
                  <div class="activity-item d-flex">
                    <div class="activite-label"><?php echo $totalMinutes ?> min ago</div>
                    <i class='bi bi-circle-fill activity-badge text-success align-self-start'></i>
                    <div class="activity-content">
                      <a href="request.php" class="fw-bold text-dark"><?php echo $request['user_name'] ?></a> request for a service to <span class="fw-bold"><?php echo $request['servicer_name'] ?></span>
                    </div>

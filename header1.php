...
<header class="mx-auto">
  <nav class="navbar navbar-expand-lg navbar-light bg-primary container mx-auto" style="position: fixed;top:0;z-index:1000;width:100%">
    <div class="container">
      <a class="navbar-brand bg-white px-5 rounded-3" href="/">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link fw-bold text-white fs-5" href="../index.php">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-bold text-white fs-5" href="#">About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-bold text-white fs-5" href="#">Services</a>
          </li>

          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle fw-bold text-white fs-5" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Dropdown
            </a>
